...
#endif  /* _UNICODE */
{
    ...
    __try {
        retval = __tinput_s(stdin, (const _TUCHAR *)_Format, _ArgList);
    }
    __finally {
...
#endif  /* _UNICODE */
{
    ...
    retval = __tinput_s(infile, (const _TUCHAR *)_Format, _ArgList);
...
static void _safecrt_fassign(int flag, void* argument, char* number, char)
{
    if ( flag != 0 )    // double
    {
        double dblValue = 0.0;
