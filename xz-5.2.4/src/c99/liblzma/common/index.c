...
index_dup_stream(const index_stream *src, const lzma_allocator *allocator)
{
  ...
  /*MiSt: warning C4244: 'function': conversion from 'const lzma_vli' to '::size_t', possible loss of data*/
	index_group *destg = lzma_alloc((size_t)(sizeof(index_group)
	...
	destg->number_base = 1;
  /*MiSt: warning C4244: '=': conversion from 'const lzma_vli' to '::size_t', possible loss of data*/
