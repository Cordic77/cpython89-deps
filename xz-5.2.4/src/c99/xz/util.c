...
error:
	message_fatal(_("Value of the option `%s' must be in the range "
				"[%" PRIu64 ", %" PRIu64 "]"),
				name, min, max);
  /*MiSt: warning C4715: 'str_to_uint64': not all control paths return a value*/
  #if defined(_MSC_VER)
  return ((uint64_t)-1);
  #endif
}
...
check_thousand_sep(uint32_t slot)
{
  #if defined(_WIN32)
  #pragma warning (push)
  #pragma warning (disable : 4474)  //warning C4474: 'snprintf' : too many arguments passed for format string
  #pragma warning (disable : 4476)  //warning C4476 : 'snprintf' : unknown type field character ''' in format specifier
  #endif
  ...
  #if defined(_WIN32)
    //warning C4476 : 'snprintf' : unknown type field character ''' in format specifier
  #pragma warning (pop)
  #endif
