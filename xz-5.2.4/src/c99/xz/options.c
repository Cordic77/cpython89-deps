		...
		const char *valuestr lzma_attribute((__unused__)))
{
	...
	switch (key) {
	case OPT_DIST:
		opt->dist = (uint32_t)value;  /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
		break;
	}
}
		...
		const char *valuestr lzma_attribute((__unused__)))
{
    ...
    /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
		opt->start_offset = (uint32_t)value;
		break;
	}
}
...
set_lzma(void *options, unsigned key, uint64_t value, const char *valuestr)
{
	...
	case OPT_DICT:
    /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
    opt->dict_size = (uint32_t)value;
		break;

	case OPT_LC:
    /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
    opt->lc = (uint32_t)value;
		break;

	case OPT_LP:
    /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
    opt->lp = (uint32_t)value;
		break;

	case OPT_PB:
    /*MiSt: warning C4244: '=': conversion from 'uint64_t' to 'uint32_t', possible loss of data*/
		opt->pb = (uint32_t)value;
		break;
