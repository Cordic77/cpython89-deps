...
#if defined(_WIN32) && defined(_MSC_VER)  //MiSt
  #define snprintf _snprintf

  extern const lzma_stream init_LZMA_STREAM_INIT;
#endif
...
//W pos -= footer_flags.backward_size + LZMA_STREAM_HEADER_SIZE;
...
//W pos -= lzma_index_total_size(this_index);
...
#	error IO_BUFFER_SIZE < LZMA_BLOCK_HEADER_SIZE_MAX
	...
	const uint32_t size = (const uint32_t)my_min(iter->block.total_size
