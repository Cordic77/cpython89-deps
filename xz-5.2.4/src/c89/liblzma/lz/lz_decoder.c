...
lzma_lz_decoder
  LZMA_LZ_DECODER_INIT = {  //MiSt
    NULL,   // lzma_coder *coder;
    NULL,   // lzma_ret (*code)(lzma_coder *restrict coder, lzma_dict *restrict dict, const uint8_t *restrict in, size_t *restrict in_pos, size_t in_size);
    NULL,   // void (*reset)(lzma_coder *coder, const void *options);
    NULL,   // void (*set_uncompressed)(lzma_coder *coder, lzma_vli uncompressed_size);
    NULL    // void (*end)(lzma_coder *coder, lzma_allocator *allocator);
  };
