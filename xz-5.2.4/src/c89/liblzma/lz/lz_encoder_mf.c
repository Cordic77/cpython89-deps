...
/// in them.
//MiSt: "private macro": in v5.2.3 the 'header' macro is only used in
//      two other macros: #define header_find and #define header_skip
//   /* In v5.2.2 this macro adds 2 additional { */
...
/// were found.
//MiSt: in v5.2.3 this macro adds 3 additional { [2 inherited from header()]
...
//MiSt: in v5.2.2 this macro adds 2 additional { [2 inherited from header()]
...
do { \
	matches_count = (uint32_t)(func(len_limit, (uint32_t)pos, cur, cur_match, mf->depth, \
